...
class PessoasForm extends TPage
{
    ...
    private static $formName = 'form_Pessoas';
    ...
    public function __construct( $param )
    {
        ...
        $validade = new TDateTime('validade');

        $nome->addValidation('Nome', new TRequiredValidator());
        $rfid->addValidation('RFID', new TRequiredValidator());
        ...
        $row3 = $this->form->addFields([new TLabel('RFID:', null, '14px', null)],[$rfid]);
        $row4 = $this->form->addFields([new TLabel('Data de Validade:', null, '14px', null)],[$validade]);
